import AddQuestion from "@/components/test/Written";
...
const AddWritten = async ({ params, searchParams }: any) => {
  ...
  return (
    <>
      <h1 className="h1-bold text-dark100_light900">Adding Written Question</h1>
